      ...
      {song && (
        <div className="h-[10%] bg-black flex justify-between items-center text-white px-4">
          <div className="lg:flex items-center gap-4">
            <img
              src={song.thumbnail ? song.thumbnail : "/image.webp"}
              className="w-12"
              alt=""
            />
          ...
          <div className="flex flex-col gap-1 m-auto items-center">
            ...
            <div className="w-full items-center flex font-thin text-green-400">
              <input
                ...
                min={"0"}
                max={"100"}
                className="progress-bar w-30 md:w-75"
          ...
          <div className="flex items-center">
            <input type="range" className="w-16 md:w-32" min={"0"}
                max={"100"} step={"0.01"} value={volume * 100} onChange={volumeChange} />
          </div>
        </div>
      )}
    </div>
