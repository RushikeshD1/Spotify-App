  ...
  return (
    ...
    <div className="w-full flex justify-between items-center font-semibold">
      ...
      <div className="flex items-center gap-4">
        ...
        {isAuth ?<p onClick={logoutUserHandler} className="px-4 py-1 bg-white text-black text-[15px] rounded-full cursor-pointer">
          Logout
        </p> : <p onClick={() => navigate("/login")} className="px-4 py-1 bg-white text-black text-[15px] rounded-full cursor-pointer">
          Login
        </p>}
      </div>
    </div>
