...
export declare const redisClient: import("@redis/client").RedisClientType<{
    ...
    ft: {
        ...
        HYBRID: {
            readonly NOT_KEYED_COMMAND: true;
            readonly IS_READ_ONLY: true;
            readonly parseCommand: (this: void, parser: import("@redis/client").CommandParser, index: import("@redis/client").RedisArgument, options?: import("@redis/search/dist/lib/commands/HYBRID.js").FtHybridOptions | undefined) => void;
            readonly transformReply: {
